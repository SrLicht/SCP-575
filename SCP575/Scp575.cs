...
namespace SCP575
{
    public class Scp575
    {
        ...
        /// Plugin version
        /// </summary>
        private const string Version = "0.0.95";
        ...
        private void Spawn575(float duration)
        {
            try
            {
                ...
                try
                {
                    Log.Debug("Applying nickname and custom info", Config.Debug);
                    hubPlayer.nicknameSync.SetNick(Config.Scp575.Nickname);
                    hubPlayer.nicknameSync.CustomPlayerInfo = Config.Scp575.CustomInfo;
